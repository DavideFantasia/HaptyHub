...
min_x = 37.0; max_x = 162.0;
min_y = -632.0; max_y = -32.0;
...
union() {
    difference() {
        ...
        place_node(162.0, -32.0, "circle", "hole");
        place_node(162.0, -162.0, "diamond", "hole");
        place_node(162.0, -377.0, "trapezoid", "hole");
        place_node(37.0, -377.0, "square", "hole");
        place_node(37.0, -507.0, "trapezoid", "hole");
        place_node(37.0, -632.0, "circle", "hole");
    }

    place_node(162.0, -32.0, "circle", "wall");
    place_node(162.0, -162.0, "diamond", "wall");
    place_node(162.0, -377.0, "trapezoid", "wall");
    place_node(37.0, -377.0, "square", "wall");
    place_node(37.0, -507.0, "trapezoid", "wall");
    place_node(37.0, -632.0, "circle", "wall");
    edge_segment([162.0, -32.0], [162.0, -162.0], true, true, "circle", "diamond");
    edge_arrow([162.0, -32.0], [162.0, -162.0], "diamond");
    edge_segment([162.0, -162.0], [162.0, -377.0], true, true, "diamond", "trapezoid");
    edge_arrow([162.0, -162.0], [162.0, -377.0], "trapezoid");
    edge_segment([162.0, -162.0], [37, -162], true, false, "diamond", "square");
    edge_segment([37, -162], [37.0, -377.0], false, true, "diamond", "square");
    edge_elbow([37, -162]);
    edge_arrow([37, -162], [37.0, -377.0], "square");
    edge_segment([37.0, -377.0], [37.0, -507.0], true, true, "square", "trapezoid");
    edge_arrow([37.0, -377.0], [37.0, -507.0], "trapezoid");
    edge_segment([162.0, -377.0], [162, -632], true, false, "trapezoid", "circle");
    edge_segment([162, -632], [37.0, -632.0], false, true, "trapezoid", "circle");
    edge_elbow([162, -632]);
    edge_arrow([162, -632], [37.0, -632.0], "circle");
    edge_segment([37.0, -507.0], [37.0, -632.0], true, true, "trapezoid", "circle");
    edge_arrow([37.0, -507.0], [37.0, -632.0], "circle");
}